...
This model explores the behavior of a smart vacuum cleaner with beliefs, desires and intentions. It has desires to clean all the dirts in the environment, beliefs about the location of the dirts, and intentions to clean the dirt ranking first in its beliefs. It will clean all the dirts in the environment, and then stop.
